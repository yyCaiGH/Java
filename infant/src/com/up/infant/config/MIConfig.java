...
import com.up.infant.config.routes.AdminRotes;
import com.up.infant.config.routes.JHRotes;
...
import com.up.infant.model._MappingKit;
 ...
 */
public class MIConfig extends JFinalConfig{

    private final Logger logger = Logger.getLogger(MIConfig.class);
