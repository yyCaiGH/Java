...
//        String jdbc = "jdbc:mysql://172.0.0.1:3306/infant?characterEncoding=utf8&zeroDateTimeBehavior=convertToNull";
        String jdbc = "jdbc:mysql://139.224.192.136:3306/my?useUnicode=true&characterEncoding=utf8&autoReconnect=true";
        String user = "root";
...
//		 base model 所使用的包名
        String baseModelPackageName = "com.up.infant.model.base";
        // base model 文件保存路径
        String baseModelOutputDir = PathKit.getWebRootPath() + "/../src/com/up/infant/model/base";

        // model 所使用的包名 (MappingKit 默认使用的包名)
        String modelPackageName = "com.up.infant.model";
